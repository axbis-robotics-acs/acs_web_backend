...
export class LoginHistService {
  ...
  async selectOne<K extends keyof LoginHist>(
    where: Pick<LoginHist, K>,
  ): Promise<LoginHist | null> {
    const results = await this.queryRegistryService.select<LoginHist>(
      LoginHist,
      where,
    );
  ...
  async create(loginHistData: LoginHist): Promise<LoginHist> {
    return this.queryRegistryService.create<LoginHist>(
      LoginHist,
      loginHistData,
      true,
    );
  ...
  async update<K extends keyof LoginHist>(
    where: Pick<LoginHist, K>,
    loginHistData: LoginHist,
  ): Promise<UpdateResult> {
    return this.queryRegistryService.update<LoginHist>(
      LoginHist,
      where,
      loginHistData,
      true,
  ...
  async delete<K extends keyof LoginHist>(
    where: Pick<LoginHist, K>,
