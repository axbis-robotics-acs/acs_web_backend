...
CREATE TABLE `acs_area_master` (
  ...
  `area_nm` varchar(255) DEFAULT NULL,
  `area_tp` varchar(255) DEFAULT NULL,
  `point_cnt` varchar(255) DEFAULT NULL,
  ...
  `prev_activity_tx` varchar(255) DEFAULT NULL,
  `activity_tx` varchar(255) DEFAULT NULL,
  `creator_by` varchar(255) DEFAULT NULL,
  ...
  `trans_tx` varchar(255) DEFAULT NULL,
...
CREATE TABLE `acs_carrier_hist` (
  ...
  `carrier_tp` varchar(255) DEFAULT NULL,
...
CREATE TABLE `acs_const_master` (
  `constant_cd` varchar(255) NOT NULL,
  `constant_tp` varchar(255) NOT NULL,
...
CREATE TABLE `acs_equipment_hist` (
  ...
  `equipment_tp` varchar(255) DEFAULT NULL,
  `status_tx` varchar(255) DEFAULT NULL,
...
CREATE TABLE `acs_lang_master` (
  ...
  `usable_fl` tinyint(1) NOT NULL DEFAULT 1 COMMENT '데이터 사용 가능 여부',
  `site_cd` varchar(50) NOT NULL COMMENT 'SITE 정보',
  `description_tx` text DEFAULT NULL COMMENT '데이터에 대한 설명',
  `prev_activity_tx` varchar(20) DEFAULT NULL COMMENT '이전 활동 내용',
  `activity_tx` varchar(20) NOT NULL DEFAULT '' COMMENT '현재 활동 내용',
  `creator_by` varchar(50) DEFAULT 'administrator' COMMENT '데이터 생성자',
  `create_at` datetime DEFAULT current_timestamp() COMMENT '생성 시간',
  `modifier_by` varchar(50) NOT NULL DEFAULT 'administrator' COMMENT '데이터 수정자',
  `modify_at` datetime NOT NULL DEFAULT current_timestamp() COMMENT '수정 시간',
  `trans_tx` varchar(100) DEFAULT NULL COMMENT '관련 트랜잭션 ID',
  `last_event_at` datetime DEFAULT NULL COMMENT '최근 이벤트 발생 시간',
...
CREATE TABLE `acs_link_master` (
  ...
  `link_nm` varchar(255) DEFAULT NULL,
  `degree_val` varchar(255) DEFAULT NULL,
  `map_uuid` bigint(11) NOT NULL COMMENT '맵 고유 ID',
  `usable_fl` tinyint(1) NOT NULL DEFAULT 1 COMMENT '데이터 사용 가능 여부',
  `site_cd` varchar(50) NOT NULL COMMENT 'SITE 정보',
  `description_tx` varchar(255) DEFAULT NULL,
...
CREATE TABLE `acs_map_master` (
  `map_uuid` bigint(11) NOT NULL COMMENT '맵 고유 ID',
  `map_nm` varchar(255) DEFAULT NULL,
  `map_val` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '맵 정보',
  `map_res` tinyint(2) NOT NULL,
  `map_ver` varchar(255) DEFAULT NULL,
  `usable_fl` tinyint(1) NOT NULL DEFAULT 1 COMMENT '데이터 사용 가능 여부',
  `site_cd` varchar(50) NOT NULL COMMENT 'SITE 정보',
  `description_tx` varchar(255) DEFAULT NULL,
  `prev_activity_tx` varchar(255) DEFAULT NULL,
...
CREATE TABLE `acs_node_master` (
  ...
  `node_nm` varchar(255) DEFAULT NULL,
  `pos_x_val` varchar(255) DEFAULT NULL,
  `pos_y_val` varchar(255) DEFAULT NULL,
  `degree_val` varchar(255) DEFAULT NULL,
  `occpyied_robot_id` varchar(255) DEFAULT NULL,
...
CREATE TABLE `acs_port_hist` (
  `hist_id` bigint(20) NOT NULL COMMENT '일련 번호',
  `port_id` varchar(255) DEFAULT NULL,
  `port_tp` varchar(255) DEFAULT NULL,
  `status_tx` varchar(255) DEFAULT NULL,
  `equipment_id` varchar(255) DEFAULT NULL,
...
CREATE TABLE `acs_robot_hist` (
  ...
  `robot_tp` varchar(255) DEFAULT NULL,
...
CREATE TABLE `acs_site_master` (
  ...
  `usable_fl` tinyint(1) NOT NULL DEFAULT 1,
  `create_at` datetime(6) NOT NULL DEFAULT current_timestamp(6),
  `modify_at` datetime(6) NOT NULL DEFAULT current_timestamp(6) ON UPDATE current_timestamp(6),
  `last_event_at` datetime DEFAULT NULL,
  `description_tx` text DEFAULT NULL,
  `prev_activity_tx` varchar(20) DEFAULT NULL,
  `activity_tx` varchar(20) NOT NULL,
  `creator_by` varchar(50) NOT NULL DEFAULT 'administrator',
  `modifier_by` varchar(50) NOT NULL DEFAULT 'administrator',
  `trans_tx` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`site_cd`),
...
CREATE TABLE `acs_transfer_control_hist` (
  ...
  `assigned_robot_id` varchar(255) DEFAULT NULL,
  `transfer_st` varchar(255) DEFAULT NULL,
  `source_port_id` varchar(255) DEFAULT NULL,
  `destination_port_id` varchar(255) DEFAULT NULL,
  `acquire_start_at` datetime DEFAULT NULL COMMENT '물품 수령 시작 시간',
  `acquire_end_at` datetime DEFAULT NULL COMMENT '물품 수령 완료 시간',
  `deposit_start_at` datetime DEFAULT NULL COMMENT '물품 예치 시작 시간',
  `deposit_end_at` datetime DEFAULT NULL COMMENT '물품 예치 완료 시간',
...
CREATE TABLE `acs_user_master` (
  ...
  `email_nm` varchar(255) DEFAULT NULL,
